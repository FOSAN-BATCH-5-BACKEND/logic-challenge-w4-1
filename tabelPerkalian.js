...
function tabelPerkalian(angka) {
  let hasilKali = ""; //buat penampung 
  for (let i = 1; i <= 10; i++){ //buat perulangan 1 - 10
    hasilKali += i+" * "+ angka +" = "+ (i * angka) + "\n";
    //buat perkaliannya (i * angka) & "\n"=buat baris baru untuk pengulangannya
  }
